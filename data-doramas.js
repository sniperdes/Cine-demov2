// ─── BASE DE DATOS DORAMAS ───────────────────────────────────────────────
        const baseDeDatosDoramas = [
            ...
            // DRAMA
            { titulo:'Hacemos lo que podemos', tmdbQuery:'모두가 자신의 무가치함과 싸우고 있다 2026', nombreKV:'hacemos-lo-que-podemos', genero:'dorama-drama', info:'⭐ 8.5 | 📺', desc:'Tras 20 años tratando de hacer su primera película, un aspirante a director toca fondo. Pero entonces conoce a una productora saturada que le ayuda a volver.' },
            ...
            { titulo:'GOBLIN El solitario ser inmortal', tmdbQuery:'GOBLIN: El solitario ser inmortal 2016', nombreKV:'goblin-el-solitario-ser-inmortal', genero:'dorama-drama', info:'⭐ 8.6 | 📺', desc:'Un ser inmortal desea terminar su existencia buscando en todo el mundo su novia que es la destinada a sacar la espada que le atraviesa el pecho y solo ella es.' },
            { titulo:'Un comeback salvaje', tmdbQuery:'Un comeback salvaje 2026', nombreKV:'un-comeback-salvaje', genero:'dorama-drama', info:'⭐ 5.9 | 📺', desc:'Triangle es un grupo de baile mixto de tres miembros que dominó las listas de éxitos a principios de los años 2000, antes de que un escándalo nocturno pusiera.' },
