// ─── BASE DE DATOS DORAMAS ───────────────────────────────────────────────
        const baseDeDatosDoramas = [
            ...
            // DRAMA
            { titulo:'Así aprenderás', tmdbQuery:'참교육 2026', nombreKV:'así-aprenderás', genero:'drama-accion', info:'⭐ 9.4 | 📺', desc:'Unos inspectores insólitos entran en escena en los colegios, con lecciones duras de las que no aparecen en los libros de texto, para acabar con las reiteradas  faltas de respeto.' },
            // ACCIÓN
