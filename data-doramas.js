// ─── BASE DE DATOS DORAMAS ───────────────────────────────────────────────
        const baseDeDatosDoramas = [
            ...
            { titulo:'Abogado de oficio', tmdbQuery:'프로보노 2025', nombreKV:'pro-bono',   genero:'dorama-drama ', info:'⭐ 8.3 | 📺', desc:'Un juez insigne cuya vida cambia de la noche a la mañana se suma al equipo de asistencia jurídica gratuita en un selecto bufete. Allí, la esperanza aflora en lugares insospechados.' },
            // ACCIÓN
